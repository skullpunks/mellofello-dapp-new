  ...
  useEffect(async () => {
    const web3 = new Web3(
      new Web3.providers.HttpProvider(
        "https://eth-mainnet.g.alchemy.com/v2/zGcZ28zZR9PjLGgQvAHDdgnY2I0O7JNk"
      )
    );
    const pContract = new web3.eth.Contract(
      NFTABI,
      "0x63b0B8f71C839F7c9B9720A3eA3fD5DaE8732dF6"
    );
